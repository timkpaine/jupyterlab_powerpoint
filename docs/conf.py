...
# -*- coding: utf-8 -*-
#
# jupyterlab_powerpoint documentation build configuration file, created by
...
_version_py = os.path.join('..', 'jupyterlab_powerpoint', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyterlab_powerpointdoc'
...
latex_documents = [
    (master_doc, 'jupyterlab_powerpoint.tex', 'jupyterlab_powerpoint Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'jupyterlab_powerpoint', 'jupyterlab_powerpoint Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jupyterlab_powerpoint', 'jupyterlab_powerpoint Documentation',
     author, 'jupyterlab_powerpoint', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    jupyterlab_powerpoint_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'jupyterlab_powerpoint'))
